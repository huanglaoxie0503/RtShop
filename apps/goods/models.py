...
class GoodsCategory(models.Model):
    ...
    desc = models.CharField(default="", max_length=500, verbose_name="类别描述", help_text="类别描述")
    category_type = models.CharField(choices=CATEGORY_TYPE, max_length=100, verbose_name="类目级别", help_text="类目级别")
    parent_category = models.ForeignKey("self", null=True, verbose_name="父类别", help_text="父目录", related_name="sub_cat", on_delete=models.CASCADE)
...
class GoodsCategoryBrand(models.Model):
    ...
    品牌名
    """
    category = models.ForeignKey(GoodsCategory, verbose_name="商品类目", null=True, blank=True, on_delete=models.CASCADE)
